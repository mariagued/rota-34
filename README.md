...
## Figma propotipação ⚠️
- [Prototipação do projeto / Figma](https://www.figma.com/file/LFcrvytuLueqWyibgu3cEy/rota-34?type=design&t=wmOKlw9H7x0nHKSH-6)<br/>
...
## Protótipo
https://www.figma.com/file/LFcrvytuLueqWyibgu3cEy/rota-34?type=design&node-id=11-2&mode=design&t=JQSiDH2EqllOenRt-0
...
- [ ] ID 22 - Realiza requisições assíncronas para APIs públicas, utilizando adequadamente conceitos como AJAX, Fetch API ou bibliotecas, para obter dados dinâmicos e realizar a manipulação e exibição dos resultados na página web.R
